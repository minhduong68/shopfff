...
$verify_code = rand(10000, 99999);
 ...
 $cmd = "INSERT INTO users (fbid, admin, name, username,  money, password, token, auth, ip, verify_code, verify, time) VALUES ('0', 0, '".$n."', '".$u."', 0, '".md5($p)."', '".$token."','".$auth."', '".$_SERVER['REMOTE_ADDR']."', '".$verify_code."', 'true', '".$time."')";
